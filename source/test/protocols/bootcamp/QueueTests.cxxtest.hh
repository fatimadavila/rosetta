...
/// @file  ././//s/o/u/r/c/e///t/e/s/t///p/r/o/t/o/c/o/l/s///b/o/o/t/c/a/m/p/QueueTests.cxxtest.hh
/// @brief  Testing test_function for the queue program
...
#include <protocols/bootcamp/Queue.cc>
...
public:
	...
	void test_first() {
		...
		TS_ASSERT( protocols::bootcamp::Queue::enqueue() == 1 );
